      ...
      {nodebrowse.map((obj, i) => { 
          ...
          return(<mesh key={i} geometry={nodes[nodebrowse[i].name].geometry} castShadow={false} >
            ...
            {...(material === "leather"
              ? leatherTextureProps
              : (
                (nodes[nodebrowse[i].name]["material"]["name"] !== "WOOD" && nodes[nodebrowse[i].name]["material"]["name"] !== "Wood" && nodes[nodebrowse[i].name]["material"]["name"] !== "Concrete")?
                fabricTextureProps : ( nodes[nodebrowse[i].name]["material"]["name"] == "Concrete" ? concreteTextureProps : (nodes[nodebrowse[i].name]["material"]["name"] == "WOOD" ? woodTextureProps: wood2TextureProps))))}
              color=
